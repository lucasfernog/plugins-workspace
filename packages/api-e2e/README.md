...
| `global-shortcut`   | register/unregister/isRegistered/unregisterAll, release on reload, error paths. Shortcuts cannot be triggered.                                                         | Skipped — desktop-only plugin.                                                           |
