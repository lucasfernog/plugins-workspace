...
| `updater`           | `check` against the fixture manifest (update / 204 / older release / static manifest without the target). Installing is never exercised.                               | Skipped — desktop-only plugin.                                                           |
