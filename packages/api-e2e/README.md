...
| `cli`               | `getMatches` shape for an argument-less launch; `getMatchesFrom` flags, values, subcommands, help/version text and parse errors.                                       | Skipped — desktop-only plugin.                                                           |
