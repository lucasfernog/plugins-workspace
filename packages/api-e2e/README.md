...
| `stronghold`        | Store records (persisted across reloads), byte paths/keys, wrong-password and unknown-client errors, vault secrets, `Vault.remove` rejections, BIP39/SLIP10, Ed25519.  | Same.                                                                                    |
