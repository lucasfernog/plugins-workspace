...
| `websocket`         | Text/binary echo, ping/pong, handshake headers, listener removal, server and client close, dropped connections, connection and argument errors.                        | Same (through `adb reverse` on Android).                                                 |
