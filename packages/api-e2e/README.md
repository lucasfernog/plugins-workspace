...
| `global-shortcut`   | register/unregister/isRegistered/unregisterAll, all-or-nothing lists, error paths. Shortcuts cannot be triggered.                                                      | Skipped — desktop-only plugin.                                                           |
