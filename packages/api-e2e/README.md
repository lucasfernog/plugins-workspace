...
| `stronghold`        | Store records (persisted across reloads), re-loading open snapshots and loaded clients, path spellings, errors, vault secrets, BIP39/SLIP10, Ed25519.                  | Same.                                                                                    |
